...
NOTE: *Making Maps* (Krygier & Wood, 2016) is [available online through the library with UM login](https://ebookcentral.proquest.com/lib/miami/reader.action?docID=4571765){:target="\_blank"}.
