...
-   Krygier, J. & Wood, D. (2016). *Making Maps: A visual Guide to Map Design for GIS (Third ed.)*. New York: The Guilford Press. [Available online through the library with UM login](https://ebookcentral.proquest.com/lib/miami/reader.action?docID=4571765){:target="\_blank"}.  
...
-   An introduction to the research question and an outline of the story that the map(s) tell
...
Students are required to bring printed copies of your final project to turn in at the beginning of the final exam period.
